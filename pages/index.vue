                ...
                <div class="board">
                    <div class="recommended-author">
                        <div class="title">
                            ...
                            <i class="fa fa-refresh"  @click="refresh()">换一批</i>
                            </nuxt-link>
                        </div>
                        <ul class="recommended-list">
                                <li>
                                    ...
                                    <a href="#"  class="follow"  @click="change()">
                                        <i :class="{'fa':true,'fa-plus':!changed,'fa-check':changed}"></i>  
                                       <span>关注</span> 
                                    </a>
